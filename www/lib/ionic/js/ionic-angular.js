...
(function() {
    ...
    IonicModule
        ...
        function($scope,
            ...
            var deregisterInstance = $ionicScrollDelegate._registerInstance(
                self, scrollViewOptions.delegateHandle,
                function() {
                    return $ionicHistory.isActiveScope($scope);
                }
            );
     ...
     *
     * Additionally, the button is automatically set to `voltar()` on click/tap. By default, the
        ...
        .directive('ionNavBackButton', ['$ionicConfig', '$document', function($ionicConfig, $document) {
            return {
                ...
                compile: function(tElement, tAttrs) {
                    ...
                    buttonEle.setAttribute('ng-click', 'voltar()');
